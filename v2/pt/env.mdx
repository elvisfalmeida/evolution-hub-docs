...
Veja o arquivo de exemplo do env no [repositório oficial](https://github.com/elvisfalmeida/ebyte-cloud-api/blob/main/Docker/.env.example).
...
| Variável | Valor | Exemplo |
| --- | --- | --- |
| CONFIG_SESSION_PHONE_CLIENT | Nome que será exibido na conexão do smartphone | Ebyte Cloud API |
