...
See the example env file in the [official repository](https://github.com/elvisfalmeida/ebyte-cloud-api/blob/main/Docker/.env.example).
...
| Variable | Value | Example |
| --- | --- | --- |
| CONFIG_SESSION_PHONE_CLIENT | Name that will be displayed on the smartphone connection | Ebyte Cloud API |
