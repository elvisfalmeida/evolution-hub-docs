...
MongoDB, a NoSQL database, is known for high performance and scalability. It's ideal for handling large data volumes in the Ebyte Cloud API.
...
**Flush and Stop**: Clears all logs from PM2, useful for troubleshooting after the update and temporarily stops the Ebyte Cloud API to safely apply updates.
...
**Ebyte Cloud API directory**: access your directory installation with the following command:
~~~
cd evolution-api
~~~
