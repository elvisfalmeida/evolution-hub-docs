...
**Flush e Stop**: Limpa todos os logs do PM2, útil para solução de problemas após a atualização e para parar temporariamente a Ebyte Cloud API para aplicar atualizações com segurança.
...
**Diretório da Ebyte Cloud API**: acesse o diretório de instalação com o seguinte comando:
~~~
cd evolution-api
~~~
